...
<div class="content-wrapper">
    <div class="content-inner">
        <div class="content-inner-box">
        	<div class="error-box">
        		<div class="info-circle times"><i class="fas fa-exclamation-triangle fa-3x"></i></div>
        		<div class="code">CODE : 500</div>
        		<div class="text">서버에서 오류가 발생하였습니다.</div>
        		<div class="text-sub">잠시 후 자동으로 페이지가 이동됩니다.</div>
        	</div>
<%--          	<div class="exception-box">
        		<h3>${exception.getMessage()}</h3>
    		    <ul>
	        		<c:forEach var="i" items="${exception.getStackTrace()}">
	        				<li>${i.toString()}</li>
	        		</c:forEach>
        		</ul>
        	</div> --%>
