...
<meta property="og:title" content="${broadcaster.nickname} : APS"/>
<meta name="author" content="아프리카 민심"/>
<meta name="description" content="인터넷방송 플랫폼 아프리카TV 커뮤니티 ${braodcaster.nickname} 게시판"/>
<meta property="og:description" content="인터넷방송 플랫폼 아프리카TV 커뮤니티 ${braodcaster.nickname} 게시판"/>
<meta property="og:image" content="https://www.afreecaps.com/resources/image/logo/header_logo.png"/>
<meta name="robots" content="index, follow"/>
<link rel="canonical" href="https://www.afreecaps.com/community/board?id=${broadcaster.id}">
<meta property="og:url" content="https://www.afreecaps.com/community/board?id=${broadcaster.id}"/>
...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/css/community/board/board_list.css">
...
<%-- 			                                	<c:choose>
			                                    ...
			                                    <div class="subject-box">
			                                        <div class="subject">
			                                            <a href="${pageContext.request.contextPath}/community/board/view/${i.id}?broadcasterId=${i.broadcaster_id}&listType=${listType}&page=${pagination.page}">${i.subject}</a>
			                                        </div>
			                                        <div class="info">
                    ...
                    <div class="function-wrapper">
                        <button class="aps-button" onclick="location.href='${pageContext.request.contextPath}/community/board/write?id=${broadcaster.id}&page=${pagination.page}'"><i class="fas fa-pen"></i> 글쓰기</button>
                    </div>
