...
$(window).resize(resize_board_modify);
function resize_board_modify() {
    ...
    <div class="content-inner">
        <div class="content-inner-box">
            <div class="container">
                ...
                <form action="${pageContext.request.contextPath}/community/board/modifyOk" method="post" onsubmit="return validModify(this);">
